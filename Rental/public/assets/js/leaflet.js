...
if (document.querySelector("#mapOverlays")) {
	...
	const tiles = L.tileLayer('../../tile.openstreetmap.org/%7bz%7d/%7bx%7d/%7by%7d.html', {
		maxZoom: 19,
...
if (document.querySelector("#mapLayersControl")) {
	...
	const osm = L.tileLayer('../../tile.openstreetmap.org/%7bz%7d/%7bx%7d/%7by%7d.html', {
		maxZoom: 19,
		attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
	});

	const osmHOT = L.tileLayer('../../%7bs%7d.tile.openstreetmap.fr/hot/%7bz%7d/%7bx%7d/%7by%7d.png', {
		maxZoom: 19,
	...
	const openTopoMap = L.tileLayer('../../%7bs%7d.tile.opentopomap.org/%7bz%7d/%7bx%7d/%7by%7d.png', {
		maxZoom: 19,
...
if (document.querySelector("#mapInteractiveChoropleth")) {
	...
	const tilesChoropleth = L.tileLayer('../../tile.openstreetmap.org/%7bz%7d/%7bx%7d/%7by%7d.html', {
		maxZoom: 19,
		attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
